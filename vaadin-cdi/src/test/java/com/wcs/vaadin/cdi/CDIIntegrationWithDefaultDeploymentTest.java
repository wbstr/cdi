...
import com.wcs.vaadin.cdi.uis.*;
import com.wcs.vaadin.cdi.views.*;
...
public class CDIIntegrationWithDefaultDeploymentTest extends
    ...
    public void browserRestartCreatesNewInstance() throws Exception {
        String uri = Conventions.deriveMappingForUI(PlainUI.class);
        openWindow(uri);
    ...
    public void cdiEventsArrivesInDependentListener()
        ...
        String uri = Conventions.deriveMappingForUI(UIWithCDIDependentListener.class);
        openWindow(uri);
        clickAndWait(BUTTON);
    ...
    public void interceptedScopedEventListener() throws IOException,
        ...
        String uri = Conventions.deriveMappingForUI(InterceptedUI.class);
        openWindow(uri);
        firstWindow.findElement(BUTTON).click();
    ...
    public void unsecuredUI() throws MalformedURLException {
        ...
        String uri = Conventions.deriveMappingForUI(UnsecuredUI.class) + "?debug";
        openWindow(uri);
    ...
    public void subView() throws MalformedURLException {
        openWindow(Conventions.deriveMappingForUI(NavigatableUI.class) + "#!main");
        waitForValue(LABEL, MainView.VIEW_ID);
        openWindow(Conventions.deriveMappingForUI(NavigatableUI.class) + "#!main/subview");
