...
import com.wcs.vaadin.cdi.internal.UIScopedBean;
import com.wcs.vaadin.cdi.internal.ViewScopedBean;
import com.wcs.vaadin.cdi.uis.NavigatableUI;
import com.wcs.vaadin.cdi.views.AbstractNavigatableView;
import com.wcs.vaadin.cdi.views.AbstractScopedInstancesView;
import com.wcs.vaadin.cdi.views.UIScopedView;
import com.wcs.vaadin.cdi.views.ViewScopedView;
...
public class ScopedInstancesTest extends AbstractManagedCDIIntegrationTest {
    ...
    public void viewInstancesInContexts() throws MalformedURLException {
        openWindow(Conventions.deriveMappingForUI(NavigatableUI.class));
