...
/**
 * Built-in ViewContextStrategy implementations.
 */
public class ViewContextStrategies {
    ...
    @NormalUIScoped
    public static class CurrentViewState {
        private String viewName;
        private String parameters;

        private void onViewChange(@Observes @AfterViewChange ViewChangeListener.ViewChangeEvent event) {
